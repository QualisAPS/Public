  ...
  return (
    <section id="features" className="pb-20">
      <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
        <article className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
          <div className="flex flex-col gap-7">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="font-medium mt-0 text-black dark:text-white text-3xl xl:text-3xl">
                Teclas de Atalho
              </h3>
              <p className="dark:text-white">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="list-disc flex flex-col gap-1 ml-6">
                ...
                <li className="dark:text-white">
                  <strong className="text-black dark:text-white">VoiceOver</strong>
                </li>
              </ul>
            </div>
          </div>
