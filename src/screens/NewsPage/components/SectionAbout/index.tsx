        ...
        <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
          ...
          <article className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10 mt-8 xl:mt-10">
            <div className="blog-details">
              ...
              <p>
                Antes do início da 1ª fase, está sendo realizado um diagnóstico
                inicial da estrutura das Unidades Básicas de Saúde (UBS) e dos
                serviços prestados pelas eSF e eSB para estabelecer a linha de
                base sobre a qualidade dos serviços da APS no DF. A primeira
                etapa do diagnóstico inicial foi a avaliação de estrutura das
                165 UBS, realizada por meio de entrevistas telefônicas e do
                preenchimento de um instrumento pelas GSAPS. Para completar esse
                o diagnóstico será realizado a autoavaliação pelas equipes de
                saúde da família e de saúde bucal e pelas Gerências de Serviços
                da Atenção Primária à Saúde (GSAPS).
              </p>
            </div>
          </article>
        </div>
